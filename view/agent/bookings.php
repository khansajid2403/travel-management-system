...
$booking = new Booking();
$bookings = $booking->getBookingsForAgent($_SESSION['user_id']);
?>
<!DOCTYPE html>
<html lang='en'>
<head>
...
<body>
	<h1 class="page-heading">Booking Requests</h1>
	...
	<table class="data-table">
		...
		<tr>
			<td>BR<?php echo str_pad($b['booking_id'], 3, '0', STR_PAD_LEFT); ?></td>
			...
			<td>
				...
				<form action="../../controller/booking-status-handler.php" method="post" style="display: inline;">
