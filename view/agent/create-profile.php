...
<body>
	<div class="card">
		...
		<?php if (isset($_SESSION['staff_success'])): ?>
			<p class="success-text"><?php echo htmlspecialchars($_SESSION['staff_success']); unset($_SESSION['staff_success']); ?></p>
		<?php endif; ?>

		<?php if (isset($_SESSION['staff_error'])): ?>
			<p class="error-text" style="text-align: center;"><?php echo htmlspecialchars($_SESSION['staff_error']); unset($_SESSION['staff_error']); ?></p>
		<?php endif; ?>

		<form action="../../controller/staff-create-handler.php" method="post" onsubmit="return validateStaffForm();">
			...
			<select id="role" name="role">
				...
				<option value="coordinator">Hotel &amp; Transport Coordinator</option>
		...
		<a href="../../" class="btn btn-outline" style="display: block; text-align: center; text-decoration: none;">Back to Dashboard</a>
	</div>
